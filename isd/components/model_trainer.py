...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        ...
        try: 
            ...
            #training
            os.system(f"cd yolov5 && python train.py --batch {self.model_trainer_config.batch_size} --cfg models/custom_yolov5s.yaml --epochs {self.model_trainer_config.no_epochs} --data data/custom.yaml --weights yolov5s.pt")
